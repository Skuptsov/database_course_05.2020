...
CREATE TABLE `profiles` (
    ...
    education VARCHAR(100), -- добавить таблицу "обр. учреждения"
...
CREATE TABLE likes (
id SERIAL PRIMARY KEY,
likes_to BIGINT UNSIGNED NOT NULL,
likes_from BIGINT UNSIGNED NOT NULL,
`status` ENUM('like', 'smile', 'love', 'angry'),
likes_count BIGINT UNSIGNED NULL,
FOREIGN KEY (likes_to) REFERENCES users(id),
FOREIGN KEY (likes_from) REFERENCES users(id)
 );
